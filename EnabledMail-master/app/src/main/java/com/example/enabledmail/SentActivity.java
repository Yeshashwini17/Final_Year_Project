...
public class SentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(getApplicationContext(), i -> {
            if (i != TextToSpeech.ERROR) {
                ...
                Toast.makeText(SentActivity.this, "Unable to start text to speech service", Toast.LENGTH_LONG).show();
            }
        });
                ...
                result -> {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        if (data != null) {
                            ...
                            Toast.makeText(SentActivity.this, "Sorry, something not right", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private void dbCollectEmails() {
        curTerm = 0;
        db.collection("mail")
                .whereEqualTo("from", user.getEmail())
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(SentActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void updateListView() {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(SentActivity.this, R.layout.mail_item, mails.stream().map((a) -> a.second).collect(Collectors.toList()));
    ...
    private void noMoreMails() {
        ...
        handler.postDelayed(() -> {
            ...
            waitForSpeakingToEnd();
            Intent intent = new Intent(SentActivity.this, DashboardActivity.class);
