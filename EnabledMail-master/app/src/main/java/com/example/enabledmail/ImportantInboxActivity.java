...
public class ImportantInboxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(getApplicationContext(), i -> {
            if (i != TextToSpeech.ERROR) {
                ...
                Toast.makeText(ImportantInboxActivity.this, "Unable to start text to speech service", Toast.LENGTH_LONG).show();
            }
        });
                ...
                result -> {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        if (data != null) {
                            ...
                            Toast.makeText(ImportantInboxActivity.this, "Sorry, something not right", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        db.collection("mail")
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ImportantInboxActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void updateListView() {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(ImportantInboxActivity.this, R.layout.mail_item, mails.stream().map((a) -> a.second).collect(Collectors.toList()));
    ...
    private void noMoreMails() {
        ...
        handler.postDelayed(() -> {
            ...
            waitForSpeakingToEnd();
            Intent intent = new Intent(ImportantInboxActivity.this, DashboardActivity.class);
