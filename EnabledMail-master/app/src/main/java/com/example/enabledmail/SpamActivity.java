...
public class SpamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(getApplicationContext(), i -> {
            if (i != TextToSpeech.ERROR) {
                ...
                Toast.makeText(SpamActivity.this, "Unable to start text to speech service", Toast.LENGTH_LONG).show();
            }
        });
                ...
                result -> {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        if (data != null) {
                            ...
                            Toast.makeText(SpamActivity.this, "Sorry, something not right", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private void updateListView() {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(SpamActivity.this, R.layout.mail_item, mails.stream().map((a) -> a.second).collect(Collectors.toList()));
        ...
        db.collection("mail")
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(SpamActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void noMoreMails() {
        ...
        handler.postDelayed(() -> {
            ...
            waitForSpeakingToEnd();
            Intent intent = new Intent(SpamActivity.this, DashboardActivity.class);
